    ...
    <div class="col-md-12">
        <div class="card border-bottom-primary">
            ...
            <div class="card-body table-responsive">
                @php
                    $details = [
                        ['name'=>'Nomor Rumah', 'value'=>$data->nomor_rumah],
                        ['name'=>'Jenis Dinding', 'value'=>$data->jenis_dinding],
                        ['name'=>'Luas m2', 'value'=>$data->luas],
                        ['name'=>'Kepala Rumah Tangga', 'value'=>$data->kepala_keluarga],
                        ['name'=>'RT/RW', 'value'=> sprintf('%03d',$data->rt) .'/'. sprintf('%03d',$data->rw)],
                        ['name'=>'Ketua RT', 'value'=>$data->ketua_rt],
                        ['name'=>'Waktu Input', 'value'=>$data->created_at],
                    ]        
                @endphp
