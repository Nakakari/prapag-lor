...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card border-bottom-primary">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a href="{{ route('data-rumah-warga.create') }}" class="btn btn-primary btn-sm" data-title="Tambah User"
                        data-toggle="tooltip">
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $row)
                                <tr>
                                    ...
                                    <td style="white-space: nowrap; text-align: center;">{{ ucwords($row->jenis_kelamin) }}
                                    </td>
                                ...
                                <td class="text-center text-nowrap">
                                    ...
                                    <td style="white-space: nowrap;">
                                        <a href="{{ asset($row->foto_rumah) }}" class="show-photo" target="_blank">Foto
                                            Rumah</a>
                                    </td>

                                    <td style="white-space: nowrap;">
                                        <a href="{{ route('data-rumah-warga.show', $row->id) }}"
                                            class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                        <a href="{{ route('data-rumah-warga.edit', $row->id) }}"
                                            class="btn btn-success btn-sm"><i class="fa fa-pen"></i></a>
                                        <a href="{{ route('data-rumah-warga.destroy', $row->id) }}"
                                            class="btn btn-danger btn-sm delete-data"><i class="fa fa-trash"></i></a>
                                        <form action="{{ route('data-rumah-warga.destroy', $row->id) }}" method="post">
                                            @method('delete')
                                            @csrf
                                        </form>
                                    </td>
    ...
    <div class="modal fade" id="modal-foto-rumah" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        aria-hidden="true">
