    ...
    <div class="col-lg-12">
        <div class="card border-bottom-primary">
            ...
            <div class="card-body">
                ...
                @if ($data)
                {!! Form::open()->route('data-rumah.update',[$data->id])->fill($data)->id('form')->put()->multipart() !!}
                @else
                {!! Form::open()->route('data-rumah.store')->id('form')->multipart() !!}
                @endif
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="jenis_dinding" class="form-control" required="" id="jenis-dinding">
                                ...
                                <option value="{{$row}}" {{$data ? ($data->jenis_dinding == $row ? 'selected':''):''}}>{{ ucwords($row) }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="jenis_lantai" class="form-control" required="" id="jenis-lantai">
                                ...
                                <option value="{{$row}}" {{$data ? ($data->jenis_lantai == $row ? 'selected':''):''}}>{{ ucwords($row) }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="jenis_atap" class="form-control" required="" id="jenis-atap">
                                ...
                                <option value="{{$row}}" {{$data ? ($data->jenis_atap == $row ? 'selected':''):''}}>{{ ucwords($row) }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="jenis_kelamin" class="form-control" required="" id="jenis-kelamin">
                                ...
                                <option value="{{$row}}" {{$data ? ($data->jenis_kelamin == $row ? 'selected':''):''}}>{{ ucwords($row) }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="ketua_rt"
                                value="{{old('ketua_rt', $data ? $data->ketua_rt:'')}}"
                                required=""
                                id="ketua_rt"
                            />
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label>RT</label>
                            <input type="text" name="rt" class="form-control" value="{{auth()->user()->ketua_rt->rt}}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label>RW</label>
                            <input type="text" name="rw" class="form-control" value="{{auth()->user()->ketua_rt->rw}}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Ketua RT</label>
                            <input type="text" name="ketua_rt" class="form-control" value="{{auth()->user()->ketua_rt->name}}" readonly>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-lg-12 mb-2">
                        ...
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" name="jamban" id="" value="1" {{$data ? ($data->jamban ? 'checked':''):''}}> Jamban
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" name="listrik" id="" value="1" {{$data ? ($data->listrik ? 'checked':''):''}}> Listrik
                            </label>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="air_bersih" class="custom-select" id="air-bersih">
                                <option value=""></option>
                                <option value="sumur_gali" {{$data ? ($data->air_bersih == 'sumur_gali' ? 'selected':''):''}}>Sumur Gali</option>
                                <option value="sumur_bor" {{$data ? ($data->air_bersih == 'sumur_bor' ? 'selected':''):''}}>Sumur Bor</option>
                                <option value="pam" {{$data ? ($data->air_bersih == 'pam' ? 'selected':''):''}}>PAM</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <div class="fom-group">
                            ...
                            <a href="{{ route('data-rumah.index') }}" class="btn btn-sm btn-light">Kembali</a>
                        </div>
                    </div>
            </div>
            </form>
...
$(document).ready(function(){
    ...
    $(document).on('change','#rw',function(e){
        ...
        $.each(rts, function(index,val){
            $('#rt').append(`<option value="${val.name}" data-ketua-rt="${val.ketua_rt}">00${val.name}</option>`)
        })
